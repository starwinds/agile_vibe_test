...
- **Web App 연동:** Valkey에 임베딩 데이터를 저장하고 벡터 검색할 수 있는 Web App을 만들고 연동합니다.
    - 사용자 요구사항:
        - 사용자로서, 텍스트 상자에 질문을 입력하고 검색 결과를 볼 수 있는 웹 페이지를 원합니다.
        - 사용자로서, 기술 자료에 새 문서를 추가하기 위해 텍스트 파일을 업로드할 수 있기를 원합니다.
        - 사용자로서, 검색 결과와 함께 원본 문서의 내용을 보고 싶습니다.
        - 관리자로서, 데이터베이스의 문서를 보고 관리할 수 있는 간단한 인터페이스를 원합니다. 
...
- **컨테이너:** Docker
- **Web App:**
    - **Backend:** Python Flask 기반의 RESTful API 제공 (`/qa`, `/add_document` 엔드포인트 포함).
    - **Frontend:** 기본적인 HTML, CSS, JavaScript를 사용한 사용자 인터페이스. 
